...
//          Toast.makeText(NumbersActivity. this, "Finished ", Toast.LENGTH_SHORT).show();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        words.add(new Word("older brother", "fratello grande", R.drawable.family_older_brother, R.raw.family_older_brother));
        words.add(new Word("older sister", "sorella grande", R.drawable.family_older_sister, R.raw.family_older_sister));
        words.add(new Word("younger brother", "fratello minore", R.drawable.family_younger_brother, R.raw.family_younger_brother));
        words.add(new Word("younger sister", "sorella minore", R.drawable.family_younger_sister, R.raw.family_younger_sister));
